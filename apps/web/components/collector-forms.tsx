...
const exporterSample = `[
  {
    ...
    "content_text": "Notion AI 适合整理知识库，官网 https://www.notion.so/product/ai。Raycast AI 适合 macOS 快速启动、脚本和 AI 问答，下载页 https://www.raycast.com。",
    "read_count": 3200,
    "like_count": 140,
    "comment_count": 12
  }
  ...
  return (
    <div className="ops-panel form">
      <div className="panel-heading">
        <h2>历史文章导入</h2>
        <span className="badge">exporter</span>
      </div>
      <p className="muted">
        用于导入 wechat-article-exporter 导出的 JSON、HTML 或纯文本内容，适合一次性补齐历史文章。
      </p>
      <div className="split">
        <input
          className="input"
...
export function WeweRssSyncForm({ integration }: { integration?: IntegrationConfig }) {
  ...
  return (
    <div className="ops-panel form">
      ...
      <p className="muted">
        用于发现已追踪公众号的新文章。系统读取 feed 列表去重后，再交给全文获取与资源解析流程。
      </p>
